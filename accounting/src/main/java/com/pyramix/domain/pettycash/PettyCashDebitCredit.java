...
@Entity
@Table(name = "petty_cash_debitcredit", schema = SchemaUtil.SCHEMA_COMMON)
public class PettyCashDebitCredit extends IdBasedObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1329839849321450481L;
	...
	public String toString() {
		return "PettyCashDebitCredit [" + super.toString() + " ,creditAmount=" 
