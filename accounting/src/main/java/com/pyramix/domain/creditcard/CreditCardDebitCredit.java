...
@Entity
@Table(name = "credit_card_debitcredit", schema = SchemaUtil.SCHEMA_COMMON)
public class CreditCardDebitCredit extends IdBasedObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2058472999902767939L;
	...
	public String toString() {
		return "CreditCardDebitCredit [" + super.toString() + ", creditAmount=" 
				+ creditAmount + ", debitAmount=" + debitAmount + ", dbcrDescription=" 
				+ dbcrDescription + ", masterCoa=" + masterCoa + "]";
	}
